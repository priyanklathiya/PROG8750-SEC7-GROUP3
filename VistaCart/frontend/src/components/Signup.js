...
function Signup() {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!isPasswordValid || !password) {
      newFormErrors.password = "Password must be at least 8 characters and contain an uppercase letter, a lowercase letter, and a special character";
    }
              ...
              <div className="card-body">
                ...
                <form onSubmit={handleFormSubmit}>
                  ...
                  <div className="password-strength">
                    <label style={{ color: 'grey' }}>Password Strength</label><br></br>
                    <progress
                      max="3"
                      value={password
                        ? password.length >= 8
                          ? /[A-Z]/.test(password) && /[a-z]/.test(password) && /[!@#$%^&*]/.test(password)
                            ? 3 // Good strength
                            : 2 // Normal strength
                          : 1 // Weak strength
